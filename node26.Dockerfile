...
# ==============================================================================
FROM node:26-trixie-slim AS app-builder
...
RUN --mount=type=cache,uid=1000,gid=1000,sharing=locked,target=/home/node/.cache \
...
# ==============================================================================
FROM node:26-trixie-slim AS main-app
...
COPY --chown=node:node --from=app-builder /data/package.json /data/yarn.lock /data/.yarnrc.yml ./
