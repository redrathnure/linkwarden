...
4. Experimental build with node.js 22 (✓)
5. Experimental build with node.js 24 (✓)
...
Node.js 20 (Debian Trixie based):
...
* tags with a `-node20` suffix.

Node.js 22 (Debian Trixie based): same as nodejs 20 but with `-node22` suffix.
